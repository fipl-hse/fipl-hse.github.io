...
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.prepare_word`.
...
Реализуйте функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.collect_frequencies`.
...
Реализуйте функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.count_tokens_pairs`.
...
Реализуйте функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.merge_tokens`.
...
Для этого реализуйте функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.train`.
...
Для этого реализуйте функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.get_vocabulary`.
...
Для этого реализуйте функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.decode`.
...
функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.tokenize_word`.
...
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.load_vocabulary`.
...
Для этого реализуйте функцию :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.encode`.
Она обязательно должна вызывать функции
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.prepare_word` и
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.tokenize_word`.
...
последовательности :py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.collect_ngrams`.
...
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.calculate_precision`.
...
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.geo_mean`.
...
Для этого реализуйте функцию
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.calculate_bleu`,
которая обязательно вызывает функции
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.collect_ngrams`,
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.calculate_precision` и
:py:func:`stubs.labs.lab_2_tokenize_by_bpe.main.geo_mean`.
