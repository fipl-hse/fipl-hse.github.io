...
2. `Работа №8 с нейросетевой языковой моделью <https://github.com/fipl-hse/2024-hello-llm/tree/main/lab_8_sft>`__
...
+------------+----------------------+--------------------------------------------------------------+
| 19.02.2025 | N/A                  | Сдача лабораторной работы №7.                                |
+------------+----------------------+--------------------------------------------------------------+
| 26.02.2025 | Тонкая настройка     | Тонкая настройка модели.                                     |
|            | языковых моделей     | `Листинг <https://github.com                                 |
|            | с помощью метода     | /fipl-hse/2024-hello-llm/blob/main                           |
|            | ``LoRA``.            | /seminars/seminar_02_26_2025/try_sft.py>`__.                 |
+------------+----------------------+--------------------------------------------------------------+
