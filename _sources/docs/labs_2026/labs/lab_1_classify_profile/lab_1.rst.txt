...
Если токены имеют одинаковую частоту, отсортируйте токены
...
* ключу ``"n_words"`` соответствует количество уникальных токенов в словаре (целое число),
...
В дальнейшем при работе с профилями необходимо будет использовать эту функцию
для проверки профиля.

Шаг 6. Сравнить два языковых профиля по пересекающимся частотным словам
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Простейший способ сравнить два языковых профиля — найти совпадающие
...
Например, топ N слов для английского языка — `['a', 'an', 'the', 'by']`,
