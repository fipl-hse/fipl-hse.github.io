...
`lab_2_tokenize_by_bpe.main.prepare_word`.
...
Реализуйте функцию `lab_2_tokenize_by_bpe.main.collect_frequencies`.
...
Реализуйте функцию `lab_2_tokenize_by_bpe.main.count_tokens_pairs`.
...
Реализуйте функцию `lab_2_tokenize_by_bpe.main.merge_tokens`.
...
Для этого реализуйте функцию `lab_2_tokenize_by_bpe.main.train`.
...
Для этого реализуйте функцию `lab_2_tokenize_by_bpe.main.get_vocabulary`.
...
Для этого реализуйте функцию `lab_2_tokenize_by_bpe.main.decode`.
...
функцию `lab_2_tokenize_by_bpe.main.tokenize_word`.
...
`lab_2_tokenize_by_bpe.main.load_vocabulary`.
...
Для этого реализуйте функцию `lab_2_tokenize_by_bpe.main.encode`.
Она обязательно должна вызывать функции
`lab_2_tokenize_by_bpe.main.prepare_word` и
`lab_2_tokenize_by_bpe.main.tokenize_word`.
...
последовательности `lab_2_tokenize_by_bpe.main.collect_ngrams`.
...
`lab_2_tokenize_by_bpe.main.calculate_precision`.
...
`lab_2_tokenize_by_bpe.main.geo_mean`.
...
Для этого реализуйте функцию
`lab_2_tokenize_by_bpe.main.calculate_bleu`,
которая обязательно вызывает функции
`lab_2_tokenize_by_bpe.main.collect_ngrams`,
`lab_2_tokenize_by_bpe.main.calculate_precision` и
`lab_2_tokenize_by_bpe.main.geo_mean`.
