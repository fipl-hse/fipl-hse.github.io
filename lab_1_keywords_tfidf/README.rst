...
Одним из наиболее простых подходов использование частотного словаря, который
показывает, как часто то или иное слово встречается в тексте. Предполагается, что более
важные слова появляются чаще, однако данный метод имеет недостаток:
...
в конкретном документе, но редко — в других текстах, получают высокий вес и рассматриваются
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Term Frequency - это отношение числа вхождений слова к общему числу слов документа.
...
являющегося частью коллекции документов.
