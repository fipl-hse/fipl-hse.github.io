...
4. С помощью значка настроек в левом нижнем углу
...
7. Для активации виртуального окружения откройте терминал
   с помощью ``Ctrl + ``` или
   нажатием трех точек в верхней панели -> Terminal -> New Terminal
...
1. Откройте терминал в среде разработки Visual Studio Code с помощью ``Ctrl + ```
   или нажатием трех точек в верхней панели -> Terminal -> New Terminal:
