...
Предположим, что структура Вашего проекта выглядит так:
...
Больше информации о работе с Visual Studio Code Вы найдёте в :ref:`starting-guide-label`.
...
.. image:: _static/FAQ/git_remote.png
