...
2. Нажмите кнопку ``Code``, выберите ``HTTPS`` и нажмите кнопку
   ...
   .. image:: ../../useful_docs/_static/fork_update/copy_original_repo_url.png
...
4. В терминале выполните команду
   ...
   .. image:: ../../useful_docs/_static/fork_update/add_upstream.png

5. В терминале выполните команду ``git fetch upstream``:

   .. image:: ../../useful_docs/_static/fork_update/fetch_upstream.png
...
6. В терминале выполните команду ``git merge upstream/main --no-edit``:
   ...
   .. image:: ../../useful_docs/_static/fork_update/merge_upstream.png
