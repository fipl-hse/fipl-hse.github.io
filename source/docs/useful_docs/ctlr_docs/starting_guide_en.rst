...
2. In the upper right corner click ``Fork``.
   ...
   .. figure:: ../_static_ctlr/starting_guide/github_forking_1.png
      :alt: forking_1

3. Click ``Create Fork``.

   .. figure:: ../_static_ctlr/starting_guide/github_forking_2.png
      :alt: forking_2
...
.. figure:: ../_static_ctlr/starting_guide/github_settings.png
   :alt: settings

3. Select ``Collaborators`` from the left menu.

   .. figure:: ../_static_ctlr/starting_guide/github_collaborators_tub.png
      :alt: add collaborator tub

4. Click ``Add people``.

   .. figure:: ../_static_ctlr/starting_guide/github_add_collaborator.png
...
5. Enter `Dmitry Uraev <https://github.com/dmitry-uraev>`__ and `Marina
   ...
   .. figure:: ../_static_ctlr/starting_guide/github_add_collaborator_finish.png
...
2. Click ``Code``, select ``HTTPS`` and click the copy button.
   ...
   .. figure:: ../_static_ctlr/starting_guide/cloning_repository.png
...
1. Open PyCharm and click ``Open``.
   ...
   .. figure:: ../_static_ctlr/starting_guide/openning_project.png
...
.. figure:: ../_static_ctlr/starting_guide/setting_interpreter.png
...
1. Open a terminal in the PyCharm development environment.
   ...
   .. figure:: ../_static_ctlr/starting_guide/pycharm_open_terminal.png
...
2. Select ``Pull Requests``.
   ...
   .. figure:: ../_static_ctlr/starting_guide/github_pull_request_highlighted.png
      :alt: pull_request_highlighted

3. Click ``New pull request``.

   .. figure:: ../_static_ctlr/starting_guide/github_new_pull_request.png
      :alt: new_pull_request

4. Click ``compare across forks``.

   .. figure:: ../_static_ctlr/starting_guide/github_compare_across_forks.png
      :alt: compare_across_forks

5. Click ``head repository`` and select your fork from the list (it
   contains your GitHub username).

   .. figure:: ../_static_ctlr/starting_guide/github_choose_fork.png
      :alt: choose_fork

6. Click ``Create pull request``.

   .. figure:: ../_static_ctlr/starting_guide/github_create_pull_request_final_step.png
...
7. Enter a name for the Pull Request.
   ...
   2. **NB**: The Pull Request name for **Lab 6** must match the
      ...
      .. figure:: ../_static_ctlr/starting_guide/github_name_pull_request.png
...
8. Click ``Assignees`` and select your mentor from the list.
   ...
   1. **NB**: You can find your mentor in **the progress sheet**.
      ...
      .. figure:: ../_static_ctlr/starting_guide/github_assignees.png
         :alt: assignees
