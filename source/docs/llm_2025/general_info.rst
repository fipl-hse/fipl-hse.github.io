...
+------------+----------------------+--------------------------------------------------------------+
| 19.01.2026 | Датасеты в           | Загрузка датасета из HuggingFace.                            |
|            | экосистеме           | `Листинг <https://github.com                                 |
|            | HuggingFace          | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_12_2026/try_datasets.py>`__                      |
|            |                      | Подготовка датасета.                                         |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
...
|            |                      | /seminar_01_12_2026/try_iter_data.py>`__                     |
+------------+----------------------+--------------------------------------------------------------+
| 26.01.2026 | Инференс             | Анализ ``PyTorch`` модели.                                   |
|            | языковых моделей.    | `Листинг <https://github.com                                 |
|            | Пакетная обработка   | /fipl-hse/2025-hello-llm/blob/main                           |
|            | и загрузка примеров  | /seminars/seminar_01_19_2026/try_info.py>`__.                |
|            | при инференсе        | Инференс модели.                                             |
|            | языковых моделей     | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main                           |
|            |                      | /seminars/seminar_01_19_2026/try_model.py>`__.               |
...
|            | качества.            | /fipl-hse/2025-hello-llm/blob/main                           |
|            |                      | /seminars/seminar_02_02_2026/try_evaluate.py>`__.            |
|            |                      | Модель как сервис.                                           |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2024-hello-llm/blob/main/                          |
|            |                      | seminars/seminar_02_02_2026/try_fastapi.py>`__.              |
+------------+----------------------+--------------------------------------------------------------+
