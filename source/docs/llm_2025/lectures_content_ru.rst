...
технические особенности реализации. Сервер. Конечные точки сервиса (``endpoint``).
...
больших языковых моделей. Основные идеи метода ``LoRA``. Библиотека PEFT. Сценарий тонкой
настройки языковой модели.

Лекция 6. Ускорение инференса языковых моделей
----------------------------------------------

Ускорение инференса больших языковых моделей с использованием низкоразрядных чисел.
Квантизация больших языковых моделей в целоисленные форматы. Фреймворки для ускорения инференса
больших языковых моделей: OpenVINO, ONNX, TensorRT.
