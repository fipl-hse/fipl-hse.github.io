...
:py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor`, который Вы реализуете в
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._tokenize`,
...
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._put`.
...
Для этого реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.get_id`.
...
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.get_token`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.encode`,
который кодирует текст. Он обязательно должен вызывать методы
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._tokenize`,
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._put` и
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.get_id`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._decode`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._postprocess_decoded_text`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.decode`,
...
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._decode` и
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor._postprocess_decoded_text`.
...
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.get_end_of_word_token`,
...
Класс :py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel`
...
Создайте класс :py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel._extract_n_grams`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel.build`,
...
с учетом некоторого контекста. Давайте посмотрим на общий вид вычисления данной вероятности:
...
следующий вид: ``(1, 7)``. Необходимо найти :math:`{P((5)|(1, 7))}`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel.get_n_gram_size`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel.generate_next_token`.
...
создайте класс :py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.GreedyTextGenerator`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.GreedyTextGenerator.run`,
...
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.encode` и
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.decode`,
а также методы
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel.get_n_gram_size` и
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel.generate_next_token`.
...
Для этого создайте класс :py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearcher`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearcher.get_next_token`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearcher.continue_sequence`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearcher.prune_sequence_candidates`,
...
:py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearchTextGenerator`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearchTextGenerator._get_next_token`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearchTextGenerator.run`,
...
а также методы
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearcher.get_next_token`,
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearcher.continue_sequence` и
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BeamSearcher.prune_sequence_candidates`.
...
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.fill_from_ngrams`.
...
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel.set_n_grams`.
...
Создайте класс :py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModelReader`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModelReader.load`,
...
Метод обязательно должен вызывать методы
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor.get_id` и
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModel.set_n_grams`.
...
Для этого реализуем метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.NGramLanguageModelReader.get_text_processor`,
...
Создайте класс :py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BackOffGenerator`.
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BackOffGenerator._get_next_token`,
...
Реализуйте метод
:py:meth:`stubs.labs_2023.lab_3_generate_by_ngrams.main.BackOffGenerator.run`,
