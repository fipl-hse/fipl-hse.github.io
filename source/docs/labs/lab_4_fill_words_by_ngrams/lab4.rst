...
:py:class:`stubs.labs_2023.lab_3_generate_by_ngrams.main.TextProcessor`.
...
Иными словами, мы хотим выбрать минимальное количество токенов,
...
3. Выявить **N** минимальное количество наиболее вероятных токенов, чья суммарная
   последовательность превышает заданный **P** или равна ему.
