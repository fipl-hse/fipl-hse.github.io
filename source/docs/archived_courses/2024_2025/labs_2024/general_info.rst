...
+------------+----------------------------+------------------------------------------------------+
| 29.11.2024 | Исключения.                | Полиморфизм.                                         |
|            |                            | `Листинг <https://github.com/fipl-hse/               |
|            |                            | 2024-2-level-labs/blob/main/seminars/                |
|            |                            | practice_9_polymorphism.py>`__.                      |
+------------+----------------------------+------------------------------------------------------+
| 06.12.2024 | Области видимости.         | Исключения.                                          |
|            |                            | `Листинг <https://github.com/fipl-hse/               |
|            |                            | 2024-2-level-labs/blob/main/seminars/                |
|            |                            | practice_10_exceptions.py>`__.                       |
|            |                            | Области видимости.                                   |
|            |                            | `Листинг <https://github.com/fipl-hse/               |
|            |                            | 2024-2-level-labs/blob/main/seminars/                |
|            |                            | practice_11_legb.py>`__.                             |
+------------+----------------------------+------------------------------------------------------+
