...
+============+======================+==============================================================+
| 12.01.2026 | Современные задачи в | Создание форка.                                              |
|            | области NLP. Анонс   | Загрузка датасета из HuggingFace.                            |
|            | лабораторной работы. | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_12_2026/try_datasets.py>`__                      |
+------------+----------------------+--------------------------------------------------------------+
| 19.01.2026 | Токенизация.         | Подготовка датасета.                                         |
|            | Анализ и инференс    | `Листинг <https://github.com                                 |
|            | языковых моделей.    | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_12_2026/try_pandas.py>`__                        |
|            |                      | Перегрузка протоколов датасета.                              |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_12_2026/try_iter_data.py>`__                     |
|            |                      | Анализ ``PyTorch`` модели.                                   |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_19_2026/try_info.py>`__.                         |
|            |                      | Инференс модели.                                             |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_19_2026/try_model.py>`__.                        |
+------------+----------------------+--------------------------------------------------------------+
| 26.01.2026 | Пакетная обработка   | Упаковка семплов через ``DataLoader``.                       |
|            | при инференсе        | `Листинг <https://github.com                                 |
|            | языковых моделей.    | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_26_2026/try_dataloader.py>`__.                   |
|            |                      | Инференс генерационной модели.                               |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_26_2026/try_generation.py>`__                    |
|            |                      | Инференс NLI модели.                                         |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_01_26_2026/try_nli.py>`__                           |
+------------+----------------------+--------------------------------------------------------------+
| 02.02.2026 | Оценка качества      | Оценка качества модели.                                      |
|            | модели. Модель как   | `Листинг <https://github.com                                 |
|            | сервис.              | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_02_02_2026/try_evaluate.py>`__.                     |
|            |                      | Модель как сервис.                                           |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2024-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_02_02_2026/try_fastapi.py>`__.                      |
+------------+----------------------+--------------------------------------------------------------+
| 09.02.2026 | Тонкая настройка     | Сдача лабораторной работы №7.                                |
|            | языковых моделей     | Тонкая настройка модели.                                     |
|            | с помощью метода     | `Листинг <https://github.com                                 |
|            | ``LoRA``.            | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_02_09_2026/try_sft.py>`__                           |
+------------+----------------------+--------------------------------------------------------------+
| 16.02.2026 | Ускорение инференса  | Использование GPU.                                           |
|            | языковых моделей.    | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2025-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_02_16_2026/try_gpu.py>`__                           |
|            |                      | Конвертация PyTorch модели в ONNX формат.                    |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2024-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_02_16_2026/try_torch_to_onnx.py>`__.                |
|            |                      | Инференс модели с помощью ONNX.                              |
|            |                      | `Листинг <https://github.com                                 |
|            |                      | /fipl-hse/2024-hello-llm/blob/main/seminars                  |
|            |                      | /seminar_02_16_2026/try_onnx.py>`__.                         |
+------------+----------------------+--------------------------------------------------------------+
| 02.03.2026 | N/A                  | Сдача лабораторной работы №8.                                |
+------------+----------------------+--------------------------------------------------------------+

Более полное содержание пройденных занятий Вы найдете в :ref:`lectures-content-llm-label-2025`.
