...
Это могут быть как неологизмы или термины, так и слова с опечатками.
...
определяемая как размер множеств, делённый на размер их объединения.

Для строк коэффициент Жаккара можно вычислять на основе символов или n-грамм.
В данной работе расчеты производятся на отдельных символов (букв).
